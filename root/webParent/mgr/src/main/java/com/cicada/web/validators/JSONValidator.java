...
public class JSONValidator implements ConstraintValidator<BeJSON, CharSequence> {
	...
	public void initialize(BeJSON annotation) {
	}
	 ...
	 *
	 * @return Returns <code>true</code> if the string is <code>null</code> or the length of <code>charSequence</code>
	 *         between the specified <code>min</code> and <code>max</code> values (inclusive), <code>false</code>
	 *         otherwise.
	 */
	public boolean isValid(CharSequence charSequence, ConstraintValidatorContext constraintValidatorContext) {
		try {
			JSONObject.fromObject(charSequence);
			return true;
		} catch (Exception e) {
			return false;
		}
