...
import com.cicada.web.interceptor.LoginInterceptor;
import com.cicada.web.interceptor.MenuInterceptor;
import com.cicada.web.perm.interceptor.PermissionInterceptor;
...
public class WebConfig extends ServiceContainer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		loginRegistry.excludePathPatterns(new String[] { "/tologin", "/login", "/logout", "/code/captcha-image",
				"/user/apply", "/user/forgotpassword", "/user/validName", "/user/create", "/user/getSecretKey",
				"/user/validate", "/user/reset" });

		registry.addInterceptor(new PermissionInterceptor()).addPathPatterns("/listUsers");

		InterceptorRegistration menuRegistry = registry.addInterceptor(new MenuInterceptor());
		menuRegistry.addPathPatterns(new String[] { "/*", "/*/*", "/*/*/*", "/*/*/*/*", "/*/*/*/*/*" });
